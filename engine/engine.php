...
switch ( $do ) {
	...
	case "cabinet": include ENGINE_DIR . '/modules/habeebjz/cabinet/index.php'; break;
	case "store": include ENGINE_DIR.'/modules/habeebjz/store/index.php'; break;
	case "register": include ENGINE_DIR.'/modules/habeebjz/register.php'; break;
	case "banlist": include ENGINE_DIR.'/modules/habeebjz/pages/banlist.php'; break;
	case "donate": include ENGINE_DIR.'/modules/habeebjz/pages/donate.php'; break;
	case "rules": include ENGINE_DIR.'/modules/habeebjz/pages/rules.php'; break;
	case "team": include ENGINE_DIR.'/modules/habeebjz/pages/team.php'; break;
